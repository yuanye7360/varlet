...
`)])],-1),P={class:"card"},L=s("h3",null,"Vite",-1),M=s("p",null,[l("Vite do not support "),s("code",null,"~"),l(" syntax and need to override "),s("code",null,"~"),l(".")],-1),O=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-comment"},"// vite.config.js"),l(`
...
`)])],-1);function U(q,D,H,I,W,A){const n=t("var-site-code-example");return c(),r("div",p,[h,d,s("div",u,[m,j,a(n,null,{default:e(()=>[_]),_:1})]),b,s("div",f,[v,a(n,null,{default:e(()=>[g]),_:1})]),s("div",y,[x,a(n,null,{default:e(()=>[w]),_:1})]),s("div",z,[V,a(n,null,{default:e(()=>[k]),_:1})]),C,s("div",T,[$,S,a(n,null,{default:e(()=>[E]),_:1})]),s("div",N,[B,a(n,null,{default:e(()=>[F]),_:1})]),s("div",P,[L,M,a(n,null,{default:e(()=>[O]),_:1})])])}var J=o(i,[["render",U]]);export{J as default};
