...
`)])],-1),k=s("div",{class:"card"},[s("h3",null,"Components Playground"),s("p",null,[a("We provide a web version of the component editor, which is convenient for you to quickly get started with each component of the component library, edit it online, share it with others, or download the code package to run locally. You can click the "),s("code",null,"{...}"),a(" icon in the upper right corner of the page or "),s("a",{href:"https://varlet-ui-playground.vercel.app"},"go here")])],-1);function w(b,x,V,A,B,C){const n=c("var-site-code-example");return p(),o("div",h,[i,d,s("div",u,[m,j,_,l(n,{"playground-ignore":""},{default:t(()=>[v]),_:1}),g,l(n,{"playground-ignore":""},{default:t(()=>[y]),_:1}),l(n,{"playground-ignore":""},{default:t(()=>[f]),_:1})]),k])}var $=e(r,[["render",w]]);export{$ as default};
