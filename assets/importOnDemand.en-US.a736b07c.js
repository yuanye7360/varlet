...
`)])],-1),C=s("p",null,[n("Special note: Function components called outside the template cannot be scanned by the plug-in, and styles still need to be introduced manually. For example, "),s("code",null,"Snackbar"),n(" is a functional component.")],-1);function B(D,A,U,R,$,N){const l=t("var-site-code-example");return c(),p("div",i,[u,d,s("div",h,[m,_,e(l,{"playground-ignore":""},{default:a(()=>[j]),_:1})]),s("div",g,[f,v,e(l,{"playground-ignore":""},{default:a(()=>[y]),_:1}),k,e(l,{"playground-ignore":""},{default:a(()=>[w]),_:1}),b,e(l,{"playground-ignore":""},{default:a(()=>[x]),_:1}),I,e(l,null,{default:a(()=>[V]),_:1}),C])])}var T=o(r,[["render",B]]);export{T as default};
